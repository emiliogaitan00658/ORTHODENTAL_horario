...
public class entrada extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public static String var_bandera = "LLEGADA";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                    if (response.equals("no")) {
                        ...
                        finish();
                        Intent intent = new Intent(entrada.this, principal.class);
                        startActivity(intent);
                    }
            }
